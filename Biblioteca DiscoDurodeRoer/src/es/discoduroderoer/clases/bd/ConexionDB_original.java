 ...
 */
public class ConexionDB_original {
     ...
     */
    public ConexionDB_original(String SGBD, String PC, String usuario, String password, String SID){
        try {
            switch(SGBD){
                case "MySQL":
            ...
            Logger.getLogger(ConexionDB_original.class.getName()).log(Level.SEVERE, null, ex);
        }
